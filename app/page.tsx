  ...
  return (
    <div suppressHydrationWarning className="min-h-screen bg-background text-foreground flex flex-col font-sans overflow-x-hidden">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="relative pt-24 sm:pt-28 md:pt-36 pb-12 sm:pb-16 md:pb-24 px-4 sm:px-6 md:px-12 flex flex-col items-center justify-center text-center overflow-hidden">
          <div className="relative z-10 max-w-4xl mx-auto space-y-4 sm:space-y-6">
            ...
            <div className="pt-4 sm:pt-6 flex justify-center items-center">
              <Link
                href="/builder"
                className="gold-shimmer text-on-primary-container px-8 sm:px-10 py-3.5 sm:py-4 rounded-full text-sm sm:text-base font-bold shadow-xl shadow-primary-container/20 hover:scale-105 transition-all duration-300"
              >
                Start Designing
              </Link>
            </div>
          ...
          <div className="mt-8 sm:mt-12 md:mt-16 relative w-full max-w-5xl mx-auto">
            <div className="floating relative aspect-[16/9] rounded-2xl overflow-hidden shadow-2xl shadow-primary/10 border-2 sm:border-4 border-white/80 dark:border-white/10">
              ...
              <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 right-4 sm:right-6 flex justify-between items-end text-white text-left">
                ...
                <Link
                  href="/builder"
                  className="px-3.5 sm:px-4 py-1.5 sm:py-2 bg-white/20 backdrop-blur-md rounded-full text-[11px] sm:text-xs font-semibold hover:bg-white hover:text-black transition-all"
                >
        ...
        <section id="how-it-works" className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 md:px-12 bg-muted/40 transition-all duration-500">
        ...
        <section id="showcase" className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 md:px-12 bg-background">
          <div className="max-w-7xl mx-auto">
            <div className="flex justify-between items-end mb-8 sm:mb-12">
              <div>
                <span className="text-xs uppercase font-bold tracking-widest text-primary">Inspiration</span>
                <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-normal text-foreground">
                  Designed by the Community
                </h2>
                <p className="text-muted-foreground text-xs sm:text-base">Get inspired by what others are crafting.</p>
              </div>
              <Link
                href="/builder"
                className="text-primary font-bold text-xs sm:text-sm flex items-center gap-1.5 hover:gap-2.5 transition-all"
              >
            ...
            <div className="flex gap-4 sm:gap-6 overflow-x-auto no-scrollbar pb-4 sm:pb-6 snap-x">
        ...
        <section id="upgrades" className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 md:px-12 bg-muted/20">
          <div className="max-w-7xl mx-auto bg-card rounded-2xl sm:rounded-3xl overflow-hidden border border-border shadow-2xl flex flex-col md:flex-row">
            <div className="md:w-1/2 p-6 sm:p-10 md:p-16 flex flex-col justify-center space-y-4 sm:space-y-6">
              <h2 className="font-display text-2xl sm:text-4xl md:text-5xl font-light text-foreground leading-tight">
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3 pt-1 sm:pt-2">
                <div className="flex items-center gap-1.5 px-3 sm:px-4 py-1.5 sm:py-2 bg-background rounded-full border border-border shadow-sm text-xs font-medium">
                  <span className="material-symbols-outlined text-primary text-xs sm:text-sm">eco</span>
                  <span>Sustainability</span>
                </div>
                <div className="flex items-center gap-1.5 px-3 sm:px-4 py-1.5 sm:py-2 bg-background rounded-full border border-border shadow-sm text-xs font-medium">
                  <span className="material-symbols-outlined text-primary text-xs sm:text-sm">handshake</span>
                  <span>Artisan Craftsmanship</span>
                </div>
                <div className="flex items-center gap-1.5 px-3 sm:px-4 py-1.5 sm:py-2 bg-background rounded-full border border-border shadow-sm text-xs font-medium">
                  <span className="material-symbols-outlined text-primary text-xs sm:text-sm">verified</span>
                  <span>Authenticity</span>
                </div>
                <div className="flex items-center gap-1.5 px-3 sm:px-4 py-1.5 sm:py-2 bg-background rounded-full border border-border shadow-sm text-xs font-medium">
                  <span className="material-symbols-outlined text-primary text-xs sm:text-sm">auto_awesome</span>
              ...
              <div className="pt-2 sm:pt-4">
                <Link
                  href="/builder"
                  className="inline-flex items-center gap-2 text-primary font-bold text-xs sm:text-sm hover:underline"
                >
        ...
        {/* Final CTA */}
        <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 md:px-12 text-center bg-background relative overflow-hidden">
